...
import tu.sofia.utils.FileUtils;
...
public class Shader {
    ...
    public void create(){
        ...
        if(GL20.glGetShaderi(vertexID, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE){
            System.err.println("Shader: " + GL20.glGetShaderInfoLog(vertexID));
            return;
        }
        ...
        if((GL20.glGetProgrami(programID, GL20.GL_VALIDATE_STATUS)) == GL11.GL_FALSE){
            System.err.println("Program validating: " + GL20.glGetProgramInfoLog(programID));
            return;
        }
